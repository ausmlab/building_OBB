...
class BuildingDataset(CustomDataset):
    """Building dataset for detection.
    ...
    def __init__(self,
        ...
        super(BuildingDataset, self).__init__(ann_file, pipeline, **kwargs)
    ...
    def load_annotations(self, ann_folder):
        """
            Args:
                ann_folder: folder that contains Building annotations txt files
        """
        cls_map = {c: i
